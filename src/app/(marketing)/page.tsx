  ...
  return (
    <>
      <section className="min-h-screen bg-[radial-gradient(hsl(0,72%,65%,40%),hsl(24,62%,73%,40%),hsl(var(--background))_60%)] flex items-center justify-center text-center text-balance flex-col gap-8 px-4">
        <h1 className="text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight px-4">
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="container py-16 flex-col gap-16 flex px-8 md:px-16">
          <h2 className="text-3xl text-center text-balance ">
            Trusted by the top modern companies
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-16">
            {/* TODO add icons of some companies */}
      ...
      <section id="pricing" className="px-8 py-16 bg-accent/5">
        <h2 className="text-4xl text-center textbalance font-semibold mb-8">
      ...
      <footer className="container pt-16 pb-6 flex flex-col sm:flex-row gap-8 sm:gap-4 justify-between items-start">
        <Link href="/">
          <BrandLogo />
        </Link>
  ...
  return (
    <Card>
      ...
      <CardFooter className="flex flex-col gap-4 items-start">
        ...
        {canRemoveBranding && (
          <Feature>Remove «Parity Deals Clone» branding </Feature>
        )}
      </CardFooter>
    </Card>
  );
